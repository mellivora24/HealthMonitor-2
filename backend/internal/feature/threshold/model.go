...
type HealthThreshold struct {
	...
	HeartRateMin   float64   `gorm:"type:decimal(6,2);default:60" json:"heart_rate_min"`
	HeartRateMax   float64   `gorm:"type:decimal(6,2);default:100" json:"heart_rate_max"`
	SpO2Min        float64   `gorm:"type:decimal(5,2);default:95" json:"spo2_min"`
	BodyTempMin    float64   `gorm:"type:decimal(4,2);default:36.1" json:"body_temp_min"`
	BodyTempMax    float64   `gorm:"type:decimal(4,2);default:37.2" json:"body_temp_max"`
	BPSystolicMin  float64   `gorm:"type:decimal(5,2);default:90" json:"bp_systolic_min"`
	BPSystolicMax  float64   `gorm:"type:decimal(5,2);default:140" json:"bp_systolic_max"`
	BPDiastolicMin float64   `gorm:"type:decimal(5,2);default:60" json:"bp_diastolic_min"`
	BPDiastolicMax float64   `gorm:"type:decimal(5,2);default:90" json:"bp_diastolic_max"`
